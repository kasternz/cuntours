...
export const copy = {
  ...
  notesLabel: {
    es: "Notas (alergias, silla de ruedas, habitación)",
    en: "Notes (allergies, wheelchair, room)",
  },
  payment: { es: "Pago", en: "Payment" },
  payAtPickup: { es: "Pagar al recoger en el hotel", en: "Pay at hotel pickup" },
  ...
  payAtPickupNote: {
    es: "El conductor confirma el pago en efectivo o tarjeta al recoger. Sin cargo hoy.",
    en: "Your driver confirms cash or card payment at pickup. No charge today.",
  },
  errRequired: {
  ...
  paidAtPickup: { es: "Al recoger en el hotel", en: "At hotel pickup" },
