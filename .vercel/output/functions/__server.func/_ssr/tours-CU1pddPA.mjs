...
//#region node_modules/.nitro/vite/services/ssr/assets/tours-CU1pddPA.js
function cn(...inputs) {
...
var tours = [
	{
		...
		description: "Zarpe desde Cancún en un catamarán de cubierta abierta. Snorkel en el arrecife, open bar tropical y tiempo libre en Playa Norte, una de las bahías más calmadas del Caribe. Guía bilingüe y toallas a bordo.",
		duration: "7 horas",
		...
		notIncluded: [
			"Propinas",
			"Fotos profesionales",
			"Impuesto de muelle (aprox. $12 USD)"
		],
		highlights: [
			"Arrecife El Meco",
			"Playa Norte",
	...
	},
	{
		...
		description: "Salida temprana hacia el Parque Marino. Dos paradas de snorkel sobre coral de cerebro y abanicos, con pez ángel, loro y a veces rayas. Grupos reducidos y briefing de conservación.",
		duration: "4 horas",
	...
	},
	{
		...
		description: "Temporada de junio a septiembre. Navegación hacia Isla Contoy / Isla Mujeres para nadar junto a tiburones ballena en su ruta de alimentación. Solo se permite un número limitado de nadadores por animal.",
		duration: "8 horas",
	...
	},
	{
		...
		description: "Tres cenotes de la riviera: uno abierto, uno semi-abierto y una caverna con estalactitas. Casco, chaleco y guía espeleólogo. Ideal si quieres agua dulce y sombra lejos de la playa.",
		duration: "6 horas",
	...
	},
	{
		...
		description: "Ferry a Cozumel y dos inmersiones de snorkel o bautizo de buceo en Palancar Gardens. Corriente suave, visibilidad de 30 metros y pared de coral. Incluye almuerzo en la isla.",
		duration: "9 horas",
		location: "Cozumel",
	...
	},
	{
		...
		description: "Salida de madrugada para entrar con el primer grupo. Recorrido de 2 horas con arqueólogo: El Castillo, el Juego de Pelota, el Observatorio y el Cenote Sagrado. Almuerzo yucateco y parada en cenote para nadar de regreso.",
		duration: "12 horas",
	...
	},
	{
		...
		description: "Recorrido por la zona amurallada de Tulum con historiador: El Castillo, el Templo de los Frescos y vistas al Caribe. Después, tiempo libre en la playa de arena blanca bajo las ruinas. Grupos de mañana para evitar el calor pico.",
		duration: "7 horas",
		location: "Tulum",
	...
	},
	{
		...
		description: "Cobá se recorre en bici entre sacbés (calzadas blancas). Subida opcional a Nohoch Mul, la pirámide más alta de Quintana Roo. Después, almuerzo en pueblo maya y nado en un cenote de caverna.",
		duration: "10 horas",
	...
	},
	{
		...
		description: "Ek Balam guarda uno de los frisos de estuco mejor conservados del mundo maya. Recorrido con epigrafista, subida a la Acrópolis y nado en un cenote cercano de agua turquesa. Menos visitado que Chichén: luz y silencio.",
		duration: "11 horas",
...
function lastMinuteTours() {
	return tours.filter((t) => t.lastMinute);
}
function relatedTours(slug, limit = 3) {
	const current = getTour(slug);
	if (!current) return tours.slice(0, limit);
	return tours.filter((t) => t.slug !== slug).sort((a, b) => {
		const same = Number(b.category === current.category) - Number(a.category === current.category);
		if (same !== 0) return same;
		return b.rating - a.rating;
	}).slice(0, limit);
}
function tourPrice(tour, adults, children) {
	return tour.price * adults + Math.round(tour.price * .6) * children;
}
...
//#endregion
export { getTour as a, relatedTours as c, tourPrice as d, tours as f, formatUsd as i, todayIso as l, cn as n, initials as o, formatDateLong as r, lastMinuteTours as s, categoryLabel as t, totalReviewCount as u };
